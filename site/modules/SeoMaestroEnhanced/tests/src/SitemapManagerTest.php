...
use SeoMaestroEnhanced\SitemapItem;
use SeoMaestroEnhanced\SitemapManager;

/**
 * Tests for the SitemapManager.
 *
 * @coversDefaultClass \SeoMaestroEnhanced\SitemapManager
 */
class SitemapManagerTest extends FunctionalTestCase
{
    ...
    public function sitemap_should_not_contain_pages_excluded_with_hook()
    {
        ...
        // Exclude $page2
        $hookId = $this->addHookAfter('SeoMaestroEnhanced::sitemapAlwaysExclude', function (HookEvent $event) use ($page2) {
    ...
    public function sitemap_should_contain_items_added_with_hook()
    {
        ...
        $this->addHookAfter('SeoMaestroEnhanced::sitemapItems', function (HookEvent $event) use ($item) {
    ...
    public function it_should_throw_an_exception_if_sitemap_path_is_not_writeable()
    {
        ...
        $this->expectException(SeoMaestroEnhancedException::class);
