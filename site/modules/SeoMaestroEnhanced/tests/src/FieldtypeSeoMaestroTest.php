...
/**
 * Tests for the SeoMaestroEnhanced fieldtype.
 *
 * @coversDefaultClass \ProcessWire\FieldtypeSeoMaestroEnhanced
 */
class FieldtypeSeoMaestroEnhancedTest extends FunctionalTestCase
{
    ...
    public function it_should_store_correct_default_values_when_dehydrating_object()
    {
        ...
        $this->wire()->addHookAfter('FieldtypeSeoMaestroEnhanced::sleepValue', function (HookEvent $event) use (&$sleepValues) {
