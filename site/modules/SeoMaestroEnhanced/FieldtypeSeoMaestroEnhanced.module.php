...
use SeoMaestroEnhanced\FormManager;
use SeoMaestroEnhanced\PageFieldValue;

/**
 * A fieldtype storing various metatags and sitemap settings for a page.
 */
class FieldtypeSeoMaestroEnhanced extends Fieldtype implements Module
{
    public static function getModuleInfo()
    {
        return [
            ...
            'installs' => 'InputfieldSeoMaestroEnhanced',
            'requires' => [
                'PHP>=7.0.0',
                'ProcessWire>=3.0.0',
                'SeoMaestroEnhanced',
    ...
    {
        return $this->wire(new PageFieldValue($page, $field, $this->seoMaestroEnhanced(), []));
    }
    ...
    public function ___wakeupValue(Page $page, Field $field, $value)
    {
        ...
        return $this->wire(new PageFieldValue($page, $field, $this->seoMaestroEnhanced(), $data));
    }
    ...
    public function getDatabaseSchema(Field $field)
    {
        ...
        // The "inherit" flags are true, if a page inherits all data of a group from the SeoMaestroEnhanced field.
    ...
    public function ___getConfigInputfields(Field $field)
    {
        ...
        $formManager = new FormManager($this->seoMaestroEnhanced());
    ...
    /**
     * @return \ProcessWire\SeoMaestroEnhanced
     */
    private function seoMaestroEnhanced()
    {
        return $this->wire('modules')->get('SeoMaestroEnhanced');
    }
     ...
     *
     * @param string $group
     * @param \SeoMaestroEnhanced\PageFieldValue $pageValue
     *
     * @return bool
     */
