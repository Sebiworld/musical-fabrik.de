...
use SeoMaestroEnhanced\InputfieldFacebookSharePreview;
use SeoMaestroEnhanced\InputfieldGooglePreview;
use SeoMaestroEnhanced\InputfieldMetaData;

/**
 * Inputfield to manage metatags and sitemap settings for a page.
 */
class InputfieldSeoMaestroEnhanced extends Inputfield
{
    /**
    ...
    {
        /** @var \SeoMaestroEnhanced\PageFieldValue $pageValue */
        $pageValue = $this->attr('value');
        /** @var \ProcessWire\FieldtypeSeoMaestroEnhanced $fieldtype */
    ...
    {
        return $this->wire(
            new FormManager($this->wire('modules')->get('SeoMaestroEnhanced'))
        );
    }
