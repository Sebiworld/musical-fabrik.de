...
class InputfieldMetaData extends InputfieldFieldset
{
    ...
    {
        $this->addClass('seomaestroenhanced-inputfield-metadata');
        ...
        $this->inputfield->addClass('seomaestroenhanced-inputfield-embed', 'wrapClass');
        ...
        $inherit->addClass('seomaestroenhanced-inputfield-embed', 'wrapClass');
        $inherit->wrapAttr('data-seomaestroenhanced-metadata-inherit', $this->inputfield->name);
        ...
        $preview->addClass('seomaestroenhanced-inputfield-embed');
        ...
        if ($this->name === 'opengraph_image' && $preview->attr('value')) {
            $image = sprintf(
                '<img class="seomaestroenhanced-opengraph-image" src="%s" alt="%s">',
                $preview->attr('value'),
