...
abstract class SeoDataBase extends WireData implements SeoDataInterface
{
     ...
     * @param array $data
     */
    public function __construct(PageFieldValue $pageFieldValue, SeoMaestroEnhanced $seoMaestroEnhanced, array $data)
    {
        parent::__construct();
    ...
    public function render()
    {
        ...
        $tags = $this->seoMaestroEnhanced->renderMetatags($tags, $this->group);
