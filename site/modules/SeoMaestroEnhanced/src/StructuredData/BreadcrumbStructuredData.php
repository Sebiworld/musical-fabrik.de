...
class BreadcrumbStructuredData extends StructuredData
{
    ...
    {
        $baseUrl = $this->wire('modules')->get('SeoMaestroEnhanced')->get('baseUrl');
        $url = $baseUrl ? $baseUrl . \ProcessWire\AppApi::getUrlRelativeToRoot($page->url) : \ProcessWire\AppApi::getHttpUrlRelativeToRoot($page->httpUrl);
