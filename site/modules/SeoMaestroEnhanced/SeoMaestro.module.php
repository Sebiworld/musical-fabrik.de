...
use SeoMaestroEnhanced\DatabaseMigrations;
use SeoMaestroEnhanced\SeoMaestroEnhancedException;
use SeoMaestroEnhanced\SitemapManager;

/**
 * The main module of SeoMaestroEnhanced, managing the XML sitemap.
 */
class SeoMaestroEnhanced extends WireData implements Module, ConfigurableModule
{
    /**
     * @var \SeoMaestroEnhanced\SitemapManager
     */
    ...
    public function __construct()
    {
        ...
        $this->wire('classLoader')->addNamespace('SeoMaestroEnhanced', __DIR__ . '/src');
    ...
    /**
     * @return \SeoMaestroEnhanced\SitemapManager
     */
    ...
    public function hookGenerateSitemap(HookEvent $event)
    {
        ...
        } catch (SeoMaestroEnhancedException $e) {
     ...
     *
     * @param \SeoMaestroEnhanced\SitemapItem[] $sitemapItems
     *
     * @return array
     */
