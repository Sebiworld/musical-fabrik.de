...
/******/ 		return __webpack_require__.p + "js/chunk." + chunkId + "-" + {"13":"ec72755099438d065dcf","53":"19a15c691f301da28c60"}[chunkId] + ".min.js"
/******/ 	}
/******/
...
/* harmony import */ var _classes_AjaxAnfrage_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(64);
...
regeneratorRuntime.mark(function _callee() {
  var chartjs, chartjsPluginDeferred, diagramme, diagrammEinsetzen, hexToRgbA;
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          hexToRgbA = function _ref3(hex, alpha) {
            if (alpha === undefined) {
              alpha = 1;
            }
          ...
          diagrammEinsetzen = function _ref2(element, args) {
            ...
            if (typ === 'bar') {
              ...
              if (_typeof(args.werte) === 'object') {
                werte = args.werte;
              }

              var labels = [];

              if (_typeof(args.labels) === 'object') {
                labels = args.labels;
              }
              ...
              if (!Object(lodash__WEBPACK_IMPORTED_MODULE_1__["isEmpty"])(werte)) {
                chartConfig.data = {
                  xLabels: [],
                  datasets: []
                };
                ...
                werte.forEach(function (wert) {
                  ...
                  if (!Object(lodash__WEBPACK_IMPORTED_MODULE_1__["startsWith"])(farbe, '#')) {
                    farbe = '#' + farbe;
                  }
              ...
              if (!Object(lodash__WEBPACK_IMPORTED_MODULE_1__["isEmpty"])(labels)) {
                  ...
                  ticks: {
                    ...
                    callback: function callback(value, index, values) {
                      ...
                      labels.every(function (element, labelIndex, _arr) {
                        if (Object(lodash__WEBPACK_IMPORTED_MODULE_1__["isNumber"])(element.wert_minimum) && element.wert_minimum > value) {
                          return true;
                        }

                        if (Object(lodash__WEBPACK_IMPORTED_MODULE_1__["isNumber"])(element.wert_maximum) && element.wert_maximum < value) {
                          return true;
                        }
              ...
              if (!Object(lodash__WEBPACK_IMPORTED_MODULE_1__["isEmpty"])(werte)) {
                ...
                werte.forEach(function (wert) {
                  ...
                  _dataset.borderColor.push(farbe);

                  _dataset.backgroundColor.push(hexToRgbA(farbe, 0.8));
                });
                chartConfig.data.datasets.push(_dataset);
              }
            }

            if (_typeof(chartConfig) !== 'object' || Object(lodash__WEBPACK_IMPORTED_MODULE_1__["isEmpty"])(chartConfig)) {
              return false;
            } // Canvas-Element bestimmen. Wenn kein Canvas-Child existiert, wird es neu angelegt.


            var canvasElement = element.querySelectorAll('canvas');
          ...
          _context.next = 4;
          return Promise.all(/* import() | chartjs */[__webpack_require__.e(53), __webpack_require__.e(13)]).then(__webpack_require__.t.bind(null, 343, 7));

        case 4:
          chartjs = _context.sent;
          _context.next = 7;
          return Promise.all(/* import() | chartjs */[__webpack_require__.e(53), __webpack_require__.e(13)]).then(__webpack_require__.bind(null, 345));

        case 7:
          chartjsPluginDeferred = _context.sent;
          Chart.plugins.register({
            deferred: {
              xOffset: 150,
              // defer until 150px of the canvas width are inside the viewport
              yOffset: '50%',
          ...
          diagramme = document.querySelectorAll('.diagramm-container');
          Array.prototype.forEach.call(diagramme, function (diagramm, index) {
            if (diagramm.getAttribute('data-page') === undefined) {
              return;
            }

            var ajaxAnfrage = new _classes_AjaxAnfrage_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"]();
