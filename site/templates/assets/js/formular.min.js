...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return ready; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return matches; });
...
/* unused harmony export createElementFromHTML */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return removeElements; });
...
var trigger = function trigger(el, eventName, data) {
  ...
  if (Object(lodash__WEBPACK_IMPORTED_MODULE_0__["indexOf"])(nativeEvents, eventName) >= 0) {
    // NativesEvent
...
var removeElements = function removeElements(elements) {
  ...
  for (var index in elements) {
    ...
    if (_typeof(item) !== 'object' || !(item instanceof Element)) {
      continue;
    }
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(9), __webpack_require__(29)(module)))
...
// EXTERNAL MODULE: ./site/templates/entwicklung/js/classes/hilfsfunktionen.js
var hilfsfunktionen = __webpack_require__(1);

// EXTERNAL MODULE: ./node_modules/lodash/lodash.js
var lodash = __webpack_require__(3);

// EXTERNAL MODULE: ./site/templates/entwicklung/js/classes/AjaxAnfrage.js
var AjaxAnfrage = __webpack_require__(64);

// EXTERNAL MODULE: ./site/templates/entwicklung/js/classes/Scrollinator.js
var Scrollinator = __webpack_require__(90);

// CONCATENATED MODULE: ./site/templates/entwicklung/js/classes/AjaxFormular.js
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var AjaxFormular_AjaxFormular =
/*#__PURE__*/
function () {
  function AjaxFormular(formularElement, options) {
    _classCallCheck(this, AjaxFormular);

    if (!Object(hilfsfunktionen["c" /* matches */])(formularElement, 'form')) {
      throw new Error('Es wurde kein Formular-Element übergeben.');
    }

    this.element = formularElement;
    this.ajaxAnfrage = new AjaxAnfrage["a" /* default */]();

    if (_typeof(options) === 'object') {
      if (_typeof(options.payload) === 'object') {
    ...
    if (typeof Scrollinator["a" /* default */] === 'function') {
      this.scrollinator = new Scrollinator["a" /* default */]();
  ...
  */
  ...
  _createClass(AjaxFormular, [{
    key: "addPayload",
    value: function addPayload(params) {
    ...
    */
    ...
    key: "isValidValue",
    value: function isValidValue(element) {
    ...
    */
    ...
    key: "isMultiSelect",
    value: function isMultiSelect(element) {
    ...
    */
    ...
    key: "getSelectValues",
    value: function getSelectValues(options) {
      var werte = [];
    ...
    */
    ...
    value: function getValues() {
      ...
      try {
        for (var _iterator2 = this.element.elements[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    key: "formularHinweiseAktualisieren",
    value: function formularHinweiseAktualisieren(hinweise) {
      var obj = this;

      if (_typeof(hinweise) !== 'object') {
        return false;
      }

      if (_typeof(hinweise.felder) === 'object') {
        for (var index in hinweise.felder) {
          var feldHinweis = hinweise.felder[index];

          if (typeof feldHinweis.name !== 'string') {
            continue;
          }

          var inputElement = this.element.querySelector("[name='" + feldHinweis.name + "']");
          ...
          if (feldHinweis.fehler !== undefined && feldHinweis.fehler && feldHinweis.fehler.length > 0) {
            Object(hilfsfunktionen["a" /* addClass */])(inputElement, 'is-invalid');

            if (typeof feldHinweis.fehler === 'string') {
              // Der Fehler wurde direkt als String angegeben
              this.feldHinweisAnzeigen(inputElement, {
                typ: 'fehler',
                text: feldHinweis.fehler
              });
            } else if (_typeof(feldHinweis.fehler) === 'object') {
            ...
            Object(hilfsfunktionen["e" /* removeClass */])(inputElement, 'is-invalid');
            var elements = inputElement.querySelector('.invalid-feedback');

            if (_typeof(elements) === 'object' && Array.isArray(elements)) {
          ...
          if (feldHinweis.erfolg !== undefined && feldHinweis.erfolg && feldHinweis.erfolg.length > 0) {
            Object(hilfsfunktionen["a" /* addClass */])(inputElement, 'is-valid');

            if (typeof feldHinweis.erfolg === 'string') {
              // Der Fehler wurde direkt als String angegeben
              this.feldHinweisAnzeigen(inputElement, {
                typ: 'erfolg',
                text: feldHinweis.erfolg
              });
            } else if (_typeof(feldHinweis.erfolg) === 'object') {
            ...
            Object(hilfsfunktionen["e" /* removeClass */])(inputElement, 'is-valid');

            var _elements = inputElement.querySelector('.valid-feedback');

            if (_typeof(_elements) === 'object' && Array.isArray(_elements)) {
      ...
      var hinweisContainer = this.element.querySelector('.hinweise');

      if (hinweisContainer) {
        // Hinweiscontainer leeren:
        hinweisContainer.innerHTML = ''; // Neue Erfolg-Hinweise anzeigen:

        if (_typeof(hinweise.erfolg) === 'object') {
          for (var _index in hinweise.erfolg) {
            var hinweis = hinweise.erfolg[_index];
        ...
        if (_typeof(hinweise.fehler) === 'object') {
          for (var _index2 in hinweise.fehler) {
            var _hinweis = hinweise.fehler[_index2];

            var _alertbox = document.createElement('div');

            _alertbox.setAttribute('class', 'alert alert-danger');

            _alertbox.setAttribute('role', 'alert');

            _alertbox.innerHTML = _hinweis;
            hinweisContainer.appendChild(_alertbox);
          }
        }
      }
    ...
    */
    ...
    key: "feldHinweisAnzeigen",
    value: function feldHinweisAnzeigen(element, hinweis) {
      if (!element) {
        return false;
      }
      ...
      if (typeof hinweis.text === 'string') {
      ...
      } else if (_typeof(hinweis.text) === 'object') {
        if (!Array.isArray(hinweis.text)) {
          ...
          hinweis.text = Object(lodash["values"])(hinweis.text);
        }

        hinweistext = Object(lodash["join"])(hinweis.text, '<br/>');
    ...
    key: "formularSperren",
    value: function formularSperren() {
      var formularFieldsets = this.element.querySelectorAll('.alle-formularelemente');
    ...
    */
    ...
    key: "submit",
    value: function submit(ajaxFormular, event) {
      event.preventDefault();
      var formular = this;
      formular.querySelector('.form-control').classList.remove('is-invalid');
      formular.querySelector('.hinweise').innerHTML = ''; // Ajax-Anfrage-Objekt klonen:

      var ajaxAnfrage = ajaxFormular.ajaxAnfrage.clone(); // Eingegebene Werte zur Anfrage hinzufügen:

      ajaxAnfrage.addPostParams(ajaxFormular.getValues());
      ajaxAnfrage.fetch().then(function (response) {
...
// CONCATENATED MODULE: ./site/templates/entwicklung/js/formular.js


Object(hilfsfunktionen["d" /* ready */])(function () {
  var formularElemente = document.querySelectorAll("form.template-formular");
  Array.prototype.forEach.call(formularElemente, function (formularElement, index) {
    try {
      ...
      var ajaxFormular = new AjaxFormular_AjaxFormular(formularElement); // Die Auswertung dieses Formulars erfolgt über eine Ajax-Anfrage an die Twack-Komponente:

      ajaxFormular.addGetParams({
        'twack-ajax': 1
      });
...
/*#__PURE__*/
function () {
  function AjaxAnfrage(wert) {
    _classCallCheck(this, AjaxAnfrage);
  ...
  _createClass(AjaxAnfrage, [{
    key: "clone",
    value: function clone() {
      var klon = new AjaxAnfrage();
      klon.url = this.url;
      klon.pfad = this.pfad;
    ...
    key: "addGetParams",
    value: function addGetParams(params) {
      Object(lodash__WEBPACK_IMPORTED_MODULE_0__["merge"])(this._getParams, params);
    }
    /*
    ...
    */
      ...
      if (queryString) {
        ...
        for (var i = 0; i < arr.length; i++) {
          ...
          if (obj[paramName]) {
            ...
            if (_typeof(obj[paramName]) !== 'object' || !Array.isArray(obj[paramName])) {
    ...
    value: function addPostParams(params) {
      Object(lodash__WEBPACK_IMPORTED_MODULE_0__["merge"])(this._postParams, params);
    }
    /**
    ...
    value: function getUrl(includeGetParams) {
      var ausgabe = this.url + this.pfad;
    ...
    value: function (_fetch) {
      ...
      for (var key in options) {
        if (key === "body" && _typeof(options[key]) === 'object') {
     ...
     */
    ,
    set: function set(wert) {
      if (typeof wert === 'string') {
        this.importGet(wert);
        return true;
      } else if (_typeof(wert) === 'object') {
...
/* harmony default export */ __webpack_exports__["a"] = (AjaxAnfrage);
...
"use strict";
/* harmony import */ var animejs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(32);
...
/* harmony import */ var _hilfsfunktionen_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1);
...
var s = function s() {
  ...
  var staticDefaults = {
    ...
    highlightSelektor: ".highlight-navigation ul.nav a.nav-link, .highlight-navigation .dropdown-menu .dropdown-item",
  ...
  function () {
    function Scrollinator(options) {
      _classCallCheck(this, Scrollinator);
      ...
      this._sektionen = {};
      this._aktiverHash = "";
      Object(_hilfsfunktionen_js__WEBPACK_IMPORTED_MODULE_1__[/* ready */ "d"])(function () {
        ...
        if (window.location.hash) {
          ...
          var aktuellePosition = window.pageYOffset || document.documentElement.scrollTop;

          if (aktuellePosition > 10) {
            return true;
          }

          var zielElement = document.querySelector(window.location.hash);

          if (_typeof(zielElement) === "object" && zielElement) {
    ...
    _createClass(Scrollinator, [{
      key: "importiere",
      value: function importiere(options) {
        if (_typeof(options) !== "object") {
          return false;
        } // Wenn nicht in options vorhanden: Standardwerte benutzen:
      ...
      key: "refreshHeaderHoehe",

      /**
       * Liest die Höhe des angegebenen Header-Elements aus, und setzt sie als Offset ein.
       */
      value: function refreshHeaderHoehe() {
        var obj = this; // TODO automatischer Refresh funktioniert noch nicht...
        ...
        if (typeof obj.headerHoeheSelector !== "string" || obj.headerHoeheSelector.length < 1) {
          return false;
        }

        var headerElement = document.querySelector(obj.headerHoeheSelector);
      ...
      key: "isLokalerLink",
      value: function isLokalerLink(link) {
        ...
        if (geteilterLink.length > 0) {
          ...
          if (linkAdresse.charAt(linkAdresse.length - 1) == "/" && linkAdresse.length > 1) linkAdresse = linkAdresse.substring(0, linkAdresse.length - 1);
          ...
          if (aktuelleAdresse.charAt(aktuelleAdresse.length - 1) == "/") aktuelleAdresse = aktuelleAdresse.substring(0, aktuelleAdresse.length - 1);
          if (linkAdresse == aktuelleAdresse) return true;
          var hrefOhneProtokoll = aktuelleAdresse.split("://");
          if (hrefOhneProtokoll.length >= 2 && linkAdresse == hrefOhneProtokoll[1]) return true;
        }
      ...
      key: "aktiviereHashListener",
      value: function aktiviereHashListener() {
        document.addEventListener("click", this.hashListener.bind(this));
      }
    }, {
      key: "deaktiviereHashListener",
      value: function deaktiviereHashListener() {
        document.removeEventListener("click", this.hashListener.bind(this));
      }
    }, {
      key: "getHashFromLink",
      value: function getHashFromLink(linkelement) {
        var obj = this;
        var hashWert = "";
        ...
        if (typeof linkelement === "string") {
          ...
          if (!linkelement || !Object(_hilfsfunktionen_js__WEBPACK_IMPORTED_MODULE_1__[/* matches */ "c"])(linkelement, 'a[href*="#"]:not([href="#"]):not([data-toggle])')) {
      ...
      key: "getZielElement",
      value: function getZielElement(linkelement) {
        var obj = this;
        var hashWert = obj.getHashFromLink(linkelement); // Sucht das Zielelement anhand der ID:

        var zielElement = document.querySelector(hashWert);
      ...
      value: function hashListener(event) {
        ...
        if (!Object(_hilfsfunktionen_js__WEBPACK_IMPORTED_MODULE_1__[/* matches */ "c"])(element, "a")) {
          element = element.closest("a");
        }

        if (!element || !Object(_hilfsfunktionen_js__WEBPACK_IMPORTED_MODULE_1__[/* matches */ "c"])(element, 'a[href*="#"]:not([href="#"]):not([data-toggle])')) {
          return true;
        }

        var zielElement = false;
      ...
      key: "hinscrollen",
      value: function hinscrollen(element, options) {
        var obj = this;
        ...
        var animeOptions = {
          ...
          duration: function duration(el, i, l) {
            return 1000 + i * 1000;
          }
        ...
        animejs__WEBPACK_IMPORTED_MODULE_0___default.a.remove("html, body");
        var scrollPosition = obj.getPositionTop(element) - obj.scrollOffset; // Scrollen stoppen, wenn der User scrollt:
        ...
        var removeScrollEventHandler = function removeScrollEventHandler() {
          for (var _i = 0; _i < scrollEvents.length; _i++) {
            var evtname = scrollEvents[_i];
            window.removeEventListener(evtname, scrollEventHandler);
          }
        };

        for (var _i2 = 0; _i2 < scrollEvents.length; _i2++) {
          var evtname = scrollEvents[_i2];
          window.addEventListener(evtname, scrollEventHandler, false);
        }

        var finishedPromise = animejs__WEBPACK_IMPORTED_MODULE_0___default()(animeOptions).finished.then(function () {
          removeScrollEventHandler();
        });
      ...
      key: "aktiviereHighlightListener",

      /**
       * Initialisiert die Listener, die Klicks auf Hash-Links auswerten und den Reload (wenn nötig) verhindern.
       */
      value: function aktiviereHighlightListener() {
        var obj = this;
        document.removeEventListener("scroll", obj.positionPruefen.bind(obj)); // document.addEventListener('click', this.hashListener.bind(this));

        if (typeof lodash__WEBPACK_IMPORTED_MODULE_2__["throttle"] === "function") {
          // wenn lodash verfügbar ist, wird die throttle-Funktion genutzt (spart Rechenleistung)
          document.addEventListener("scroll", Object(lodash__WEBPACK_IMPORTED_MODULE_2__["throttle"])(obj.positionPruefen.bind(obj), 100));
        } else {
          document.addEventListener("scroll", obj.positionPruefen.bind(obj));
        }
      }
    }, {
      key: "deaktiviereHighlightListener",
      value: function deaktiviereHighlightListener() {
      ...
      key: "ueberwacheSelektor",
      value: function ueberwacheSelektor(selektorString, options) {
        var obj = this;
        var elemente = document.querySelectorAll(selektorString);
        ...
        for (var index in elemente) {
          ...
          } catch (err) {// console.log(err, selektorString, typeof element, element);
          }
        }
      ...
      key: "ueberwacheLink",
      value: function ueberwacheLink(linkelement, options) {
        var obj = this;
        ...
        var sektionsElement = obj.getZielElement(linkelement);
        ...
        var hashWert = sektionsElement.getAttribute("id");
        ...
        var aktivKlasse = "active";

        if (typeof options.aktivKlasse === "string" && options.aktivKlasse.length > 0) {
          aktivKlasse = options.aktivKlasse;
        } else if (typeof obj.aktivKlasse === "string" && obj.aktivKlasse.length > 0) {
          aktivKlasse = obj.aktivKlasse;
        }

        var aktiviereParent = false;
        ...
        var aktiviereParentSelektor = "";

        if (typeof options.aktiviereParentSelektor === "string" && options.aktiviereParentSelektor.length > 0) {
          aktiviereParentSelektor = options.aktiviereParentSelektor;
        } else if (typeof obj.aktiviereParentSelektor === "string" && obj.aktiviereParentSelektor.length > 0) {
          aktiviereParentSelektor = obj.aktiviereParentSelektor;
        }

        if (_typeof(obj.sektionen[hashWert]) === "object") {
          ...
          Object(lodash__WEBPACK_IMPORTED_MODULE_2__["remove"])(obj.sektionen[hashWert], function (n) {
            if (_typeof(n) !== "object") return true;
      ...
      key: "positionPruefen",
      value: function positionPruefen() {
        var obj = this;
        var aktuellePosition = window.pageYOffset || document.documentElement.scrollTop;
        var etwasGefunden = false; // Pro Sektion wird geprüft, ob diese gerade aufgrund der Scrollposition aktiv ist:

        for (var hashWert in obj.sektionen) {
          var sektion = obj.sektionen[hashWert];

          if (aktuellePosition >= obj.getPositionTop(sektion.element) - obj.scrollOffset - 1 && aktuellePosition <= obj.getPositionBottom(sektion.element) - obj.scrollOffset) {
      ...
      key: "aktiviereSektion",
      value: function aktiviereSektion(sektion) {
        var obj = this;
        ...
        for (var index in sektion.navLinks) {
          var navLink = sektion.navLinks[index];
          var elementZumAktivieren = navLink.element;
          ...
          if (navLink.aktiviereParent) {
            ...
            if (typeof navLink.aktiviereParentSelector === "string" && navLink.aktiviereParentSelector.length > 0) {
              elementZumAktivieren = navLink.element.closest(navLink.aktiviereParentSelector);
            }
          }

          Object(_hilfsfunktionen_js__WEBPACK_IMPORTED_MODULE_1__[/* addClass */ "a"])(elementZumAktivieren, navLink.aktivKlasse); // In Dropdowns: Dropdown-Parent ebenfalls als Aktiv markieren

          if (Object(_hilfsfunktionen_js__WEBPACK_IMPORTED_MODULE_1__[/* hasClass */ "b"])(elementZumAktivieren, "dropdown-item")) {
            Object(_hilfsfunktionen_js__WEBPACK_IMPORTED_MODULE_1__[/* addClass */ "a"])(elementZumAktivieren.closest(".dropdown").querySelector(".nav-link.dropdown-toggle"), navLink.aktivKlasse);
          }
        }
      }
    }, {
      key: "deaktiviereAlleSektionen",
      value: function deaktiviereAlleSektionen(hashLoeschen) {
        var obj = this;
        ...
        for (var hashWert in obj.sektionen) {
          ...
          for (var index in sektion.navLinks) {
            var navLink = sektion.navLinks[index];
            var elementZumDeaktivieren = navLink.element;
            ...
            if (navLink.aktiviereParent) {
              ...
              if (typeof navLink.aktiviereParentSelector === "string" && navLink.aktiviereParentSelector.length > 0) {
                elementZumDeaktivieren = navLink.element.closest(navLink.aktiviereParentSelector);
              }
            }

            Object(_hilfsfunktionen_js__WEBPACK_IMPORTED_MODULE_1__[/* removeClass */ "e"])(elementZumDeaktivieren, navLink.aktivKlasse); // In Dropdowns: Dropdown-Parent ebenfalls als Aktiv entfernen

            if (Object(_hilfsfunktionen_js__WEBPACK_IMPORTED_MODULE_1__[/* hasClass */ "b"])(elementZumDeaktivieren, "dropdown-item")) {
              Object(_hilfsfunktionen_js__WEBPACK_IMPORTED_MODULE_1__[/* removeClass */ "e"])(elementZumDeaktivieren.closest(".dropdown").querySelector(".nav-link.dropdown-toggle"), navLink.aktivKlasse);
            }
          }
        }
      }
      ...
      set: function set(wert) {
        ...
        if (this._navigationHighlighting) {
          ...
          if (typeof this.highlightSelektor === "string" && this.highlightSelektor.length > 0) {
      ...
      key: "sektionen",
      get: function get() {
        if (this._sektionen === undefined || _typeof(this._sektionen) !== "object") {
          this.sektionen = {};
        }
      ...
      key: "aktiverHash",
      set: function set(hashWert) {
        if (this._aktiverHash != hashWert) {
          if (history.pushState) {
            if (typeof hashWert === "string" && hashWert.length > 0) {
              history.pushState(null, document.title, window.location.pathname + "#" + hashWert + window.location.search);
            } else {
      ...
      value: function getInstance(options) {
        ...
        scrollinatorInstanz = new Scrollinator(options); // 	console.log("Instanz gesetzt.", scrollinatorInstanz);
        // } else {
