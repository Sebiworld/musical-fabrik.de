...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
  ...
  var fields = ["zeitpunkt_freischalten_ab", "zeitpunkt_freischalten_bis", "apikey_abweisungsnachricht", "maximum_fehlversuche"]; // Felder durchlaufen und für die Checkboxen on-change Handler setzen:

  fields.forEach(function (element, index, array) {
    var checkboxSelector = ".Inputfield_" + element + "_aktivieren input[name=" + element + "_aktivieren]";
