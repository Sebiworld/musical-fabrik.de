...
/******/ 		return __webpack_require__.p + "js/chunk." + chunkId + "-" + {"54":"1f02e3b19d3a6ddb7528"}[chunkId] + ".min.js"
/******/ 	}
/******/
  ...
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          playerElemente = document.querySelectorAll('.audioplayer');
          ...
          _context.next = 4;
          return __webpack_require__.e(/* import() | mediaelement */ 54).then(__webpack_require__.t.bind(null, 347, 7));

        case 4:
          Object(_classes_hilfsfunktionen_js__WEBPACK_IMPORTED_MODULE_0__[/* ready */ "d"])(function () {
            var _loop = function _loop(index) {
              var element = playerElemente[index];
              ...
              var audiodateiParent = element.closest('.audiodatei');

              if (_typeof(audiodateiParent) !== 'object' || !(audiodateiParent instanceof Element)) {
                return "continue";
              }

              var playButtons = audiodateiParent.querySelectorAll('[data-audioplayer-aktion="play"]');

              if (playButtons.length > 0) {
                for (var _index in playButtons) {
                  var _element = playButtons[_index];

                  if (_typeof(_element) !== 'object' || !(_element instanceof Element)) {
                    continue;
                  }
            ...
            for (var index in playerElemente) {
