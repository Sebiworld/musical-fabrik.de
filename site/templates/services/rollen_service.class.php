 ...
 */
class RollenService extends TwackComponent {
	...
	public function __construct($args) {
		...
		if ($this->portraitsContainer->count < 1) {
			throw new ComponentNotInitialisedException('RollenService', 'Es wurden keine passenden Portraits-Container gefunden.');
		}
	}
