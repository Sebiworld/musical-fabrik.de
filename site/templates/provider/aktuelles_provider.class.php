 ...
 */
class AktuellesProvider extends TwackComponent {

	protected $projektseite = false;
	protected $uebersichtsseitenProvider = false;
	...
	public function getBeitraege($args = array()) {
		...
		// $args für den ÜbersichtsseitenProvider aufbereiten:
		if (isset($args['zeichenLimit'])) {
			$args['limit'] = $args['zeichenLimit'];
		} else {
			unset($args['limit']);
		}
		$beitraege = $this->uebersichtsseitenProvider->formatieren($beitraege, $args);
