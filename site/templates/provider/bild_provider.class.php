 ...
 */
class BildProvider extends TwackComponent {

	protected $konfigurationProvider;

	public function __construct($args) {
		parent::__construct($args);
		$this->konfigurationProvider = $this->getProvider('KonfigurationProvider');
	}
	...
	public function getPlatzhalterbilder() {
		...
		$konfigurationsseite = $this->konfigurationProvider->getKonfigurationsseite();
