...
?>
<div class="card termin-card" data-id="<?= $this->page->id; ?>">
	<?php
	if ($this->page->titelbild) {
		?>
		<div class="seitenverhaeltnis card-img-top sv-2-1">
			<?php
			echo $this->component->getProvider('BildProvider')->getBildTag(array(
				'bild' => $this->page->titelbild,
				'ausgabeAls' => 'bg-image',
				'classes' => 'sv-inhalt termin-bild',
				'normal' => array(
					'height' => 300
				)
			));
		...
		<div class="seitenverhaeltnis card-img-top sv-2-1">
			<?php
			echo $this->component->getProvider('BildProvider')->getPlatzhalterBildTag(array(
				'ausgabeAls' => 'bg-image',
				'classes' => 'sv-inhalt termin-bild',
				'normal' => array(
					'height' => 300
