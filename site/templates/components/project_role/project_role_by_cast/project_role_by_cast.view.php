...
if (!empty($this->portraits) && !empty($casts)) {
    ...
    if ($castInfosAvailable) {
		...
		<div class="casts-description-wrapper">
			<div class="casts-description card" id="casts-description_<?= $this->season->id; ?>">
				<div class="image-wrapper">
					<img src="<?= wire('config')->urls->templates; ?>assets/static_img/friends.svg" class="card-img" alt="Casts as friends">
				</div>
				<div class="content-wrapper">
					<div class="card-body">
						<h2 class="card-title"><?= __('Our casts'); ?></h2>
						<p><?= __('At our musical projects we like to work with two equal casts for every main role, which can support each other and improve their acting skills.'); ?></p>
					</div>
