...
if ($this->images && count($this->images) > 0) {
	?>
	<div class="swiper-container card-img-top" <?= $this->autoplay ? 'data-autoplay="' . $this->autoplay . '"' : ''; ?> <?= $this->hoverAutoplay ? 'data-hover-autoplay="true"' : ''; ?> <?= $this->loop ? 'data-loop="true"' : ''; ?>>
		<div class="swiper-wrapper">
			...
			foreach ($this->images as $image) {
				...
				<div class="swiper-slide">
					...
					<a class="stretched-link" href="<?= $this->page->url; ?>"></a>
				</div>
				<?php
			} ?>
		</div>
