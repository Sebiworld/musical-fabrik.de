...
require 'mf_comment_form.class.php';
require 'mf_comment_list.class.php';
require 'mf_comment_stars.class.php';
...
class MfCommentArray extends CommentArray {
	/**
	...
	public function getCommentList(array $options = array()) {
		return $this->wire(new MfCommentList($this, $options));
	}
