...
?>
<div class="articles_tiles results-container"
	data-request-url="<?= $this->requestUrl; ?>">
	<?php
    if ($this->totalNumber) {
      ?>
  ...
  ?>
	...
	<div class="btn-group-wrapper">
		<div class="btn-group" role="group">
			<button type="button"
				class="btn btn-project-primary <?= !$this->moreAvailable ? 'd-none' : ''; ?>"
				data-action="load-more"
				data-offset="<?= $this->lastElementIndex + 1; ?>"><?= __('Load more...'); ?></button>
		</div>
	</div>
</div>